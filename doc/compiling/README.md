...
General options and their default values:
    ...
    USE_SDL3=TRUE              - Build with SDL3; Enables IrrlichtMt device SDL3
    USE_SDL3_STATIC=TRUE       - Links with SDL3::SDL3-static instead of SDL3::SDL3
...
Library specific options:
    ...
    SDL3_DLL                        - Only if building with SDL3 on Windows; path to libSDL3.dll
    SDL3_INCLUDE_DIRS               - Only if building with SDL3; directory where SDL.h is located
    SDL3_LIBRARIES                  - Only if building with SDL3; path to libSDL3.a/libSDL3.so/libSDL3.lib
